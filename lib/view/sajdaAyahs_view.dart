...
//                fontWeight: FontWeight.bold, fontSize: height * 0.045)),
  ...
  Widget infoInAppBar(BuildContext context) {
    TextStyle headline1= TextStyle( fontFamily: 'Sogeo', fontSize: 42, fontWeight: FontWeight.w600);
  ...
  Widget sajdaInfo(int ruku, int juz, int manzil, String relevationType,
    ...
    return Directionality(
      ...
      child: Shimmer.fromColors(
        ...
        child: Column(
          children: <Widget>[
            Text("--- معلومات عن الآيه ---\n",
                style:
                    TextStyle(color: Colors.black, fontWeight: FontWeight.w600)),
            infoText(" رقم الجزء", juz.toString(), context),
            infoText("رقم الصفحه", ruku.toString(), context),
